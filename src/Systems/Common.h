...
inline bool Line(glm::vec2 mouse, glm::vec2 start, glm::vec2 end, float thickness)
{
...
namespace Animation
{
template <typename T> inline T Lerp(const T& current, const T& target, float t, float epsilon = 0.001f)
{
