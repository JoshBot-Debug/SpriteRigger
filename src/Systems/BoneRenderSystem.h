...
public:
  ...
  void Initialize(ECS::Registry* registry, Shader* shader, OrthographicCamera* camera)
  {
    m_Camera   = camera;
    m_Shader   = shader;
    m_Registry = registry;
    ...
    glVertexAttribPointer(1, 2, GL_FLOAT, GL_FALSE, sizeof(Bone), (void*)offsetof(Bone, start));
    glVertexAttribDivisor(1, 1);

    // layout(location = 2) in vec2 a_end;
    glEnableVertexAttribArray(2);
    glVertexAttribPointer(2, 2, GL_FLOAT, GL_FALSE, sizeof(Bone), (void*)offsetof(Bone, end));
    glVertexAttribDivisor(2, 1);

    // layout(location = 3) in float a_thickness;
    glEnableVertexAttribArray(3);
    glVertexAttribPointer(3, 1, GL_FLOAT, GL_FALSE, sizeof(Bone), (void*)offsetof(Bone, thickness));
    glVertexAttribDivisor(3, 1);

    // layout(location = 4) in vec4 a_color;
    glEnableVertexAttribArray(4);
    glVertexAttribPointer(4, 4, GL_FLOAT, GL_FALSE, sizeof(Bone), (void*)offsetof(Bone, color));
    glVertexAttribDivisor(4, 1);

    // layout(location = 5) in vec4 a_sColor;
    glEnableVertexAttribArray(5);
    glVertexAttribPointer(5, 4, GL_FLOAT, GL_FALSE, sizeof(Bone), (void*)offsetof(Bone, sColor));
    glVertexAttribDivisor(5, 1);

    // layout(location = 6) in vec4 a_sColor;
    glEnableVertexAttribArray(6);
    glVertexAttribPointer(6, 4, GL_FLOAT, GL_FALSE, sizeof(Bone), (void*)offsetof(Bone, eColor));
  ...
  void Update(void* d) override
  {
    ...
    m_Shader->setUniformMatrix4fv("u_ViewProjection", m_Camera->GetViewProjectionMatrix());
