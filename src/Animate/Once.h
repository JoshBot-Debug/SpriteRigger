...
class Once : public ITimeline<Once<T, P>>, public Animation, public std::enable_shared_from_this<Once<T, P>>
{
private:
...
public:
  static std::shared_ptr<Once<T, P>> Create(std::shared_ptr<Animate::Timeline> timeline = Animate::Timeline::Create())
  {
  ...
  std::shared_ptr<Once<T, P>> OnUpdate(P* userData, void (*onUpdate)(P* userData))
  {
    m_UserData = userData;
    m_OnUpdate = onUpdate;
    return this->shared_from_this();
