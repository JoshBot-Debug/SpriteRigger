...
public:
  ...
  template <typename T, typename... Args> std::shared_ptr<T> PushLayer(Args&&... args)
  {
  ...
  static void    AddFont(const std::string& filepath, const std::string& name, float fontSize = 0.0f,
  ...
  static void GenerateFrameBuffer(const ImVec2& viewport, GLuint& frameBuffer, GLuint& depthBuffer,
                                  GLuint& colorAttachment);

  static void GenerateMSAAFrameBuffer(const ImVec2& viewport, GLuint& frameBuffer, GLuint& colorAttachment,
